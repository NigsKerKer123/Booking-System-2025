<nav class="fixed top-0 z-50 w-full border-b border-[#561C24] bg-[#6D2932]">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="" class="flex ms-2 md:me-24">
          <img src="{{asset('images/ReadSphere_Logo.png')}}" class="h-16 me-3" alt="ReadSphere Logo" />
      ...
      <div class="flex items-center">
          <div class="flex items-center ms-3">
            <div>
              <button type="button" class="flex text-sm bg-[#561C24] rounded-full focus:ring-4 focus:ring-[#561C24]" aria-expanded="false" data-dropdown-toggle="dropdown-user">
            ...
            <div class="z-50 hidden my-4 text-base list-none bg-[#561C24] divide-y divide-[#561C24] rounded-sm shadow-sm" id="dropdown-user">
              ...
              <ul class="py-1" role="none">
                ...
                <li>
                  <a href="#" data-modal-target="logout-modal" data-modal-toggle="logout-modal" class="block px-4 py-2 text-sm text-white hover:bg-[#6D2932]" role="menuitem">Sign out</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow-sm">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <form action="{{ Auth::check() && Auth::user()->role === 'landlord' ? route('logout') : route('student.logout') }}" method="GET">
                    <button type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Confirm
                    </button>
                    <button data-modal-hide="logout-modal" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100">
                        Cancel
                    </button>
                </form>
